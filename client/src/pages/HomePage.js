  ...
  return (
    <>
      <div
        ...
        className="flex w-full h-screen justify-center p-4 font-['Poppins']"
      >
        <div className="w-96 flex h-full flex-col  justify-center">
          ...
          <div>
            ...
            <p className="italic text-sm text-zinc-200">
              But we'll surely make it after mid-eval!
            </p>
          </div>
          <Button
            className="w-24 bg-gradient-to-r from-primary to-danger font-bold my-4"
            radius="sm"
          >
          ...
          <Button
            ...
            radius="sm"
          >
            <Link to="./Student_details" relative="path">
             test
            </Link>
          </Button>
        </div>
